...
2. Login as **paula** on the BIG-IQ and select ``site36.example.com`` under application ``IT_apps``.
...
4. Login as **larry**, look for more details on the violation under Monitoring > EVENTS > Web Application Security > Event Logs > Events
