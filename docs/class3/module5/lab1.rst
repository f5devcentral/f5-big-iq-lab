Lab 5.1: BIG-IQ integration with F5 Beacon (new 8.0)
----------------------------------------------------
...
Be aware that for this lab you will not make any additional costs. Subscribing to Beacon comes with a **45 day free trial**.
