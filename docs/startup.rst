...
+=========================+=========+==============================================================================================+=================================+
| BIG-IQ CM               | 8.1     | Using BIG-IQ, you can centrally manage your BIG-IP devices,                                  | - admin/purple123 *(local)*     |
...
+-------------------------+---------+----------------------------------------------------------------------------------------------+---------------------------------+
| BIG-IQ DCD              | 8.1     | A data collection device (**DCD**) is a specially provisioned                                | admin/purple123                 |
